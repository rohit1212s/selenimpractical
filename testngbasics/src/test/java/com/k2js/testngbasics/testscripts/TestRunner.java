...
public class TestRunner {
	...
	public void printBrowserDetails(@Optional("chrome")String b) {
		this.bn=b;
		System.out.println(this.bn+"Execution started");
	}
	
	@Parameters({"browser","runmode"})
	
	
	@BeforeClass(groups = {"High"})
	...
	@AfterClass(groups = {"High"})
	public void classCompleted() {
		System.out.println(this.getClass().getName()+"is completed");
	}
	
	@AfterTest(groups = {"High"})
	public void completedBrowsers() {
		System.out.println(this.bn +"Execution is completed successfully");
	}
